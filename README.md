1) Array Manipulation, Object Operations, Logical Operations , these three problem solution can be run by running repective javascript files.(e.g.node Array_Manipulation.js)
